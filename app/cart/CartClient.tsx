            ...
            <Header />
                <main className={css.page}>
                    ...
                    <div className={css.top}>
                        ...
                        <p className={css.subtitle}> {totalQty} produktů v košíku </p>
                        </div>
                    ...
                    {items.length === 0 ? (
                        ...
                        <div className={css.products}>
                            ...
                            <article key={item._id} className={css.card}>
                                <button className={css.removeBtn} onClick={() => removeFromCart(item._id)}>
                                ×
                                </button>

                                <div className={css.imageWrapper}>
                                {item.image ? (
                                    <Image src={item.image} alt={item.name} fill className={css.image} />
                                ) : (
                                ...
                                <div className={css.infoTop}>
                                    ...
                                    <span className={css.unitPrice}>{item.price} Kč / ks</span>
                                </div>

                                <div className={css.infoBottom}>
                                    <div className={css.qty}>
                                    <button className={css.qtyBtn} onClick={() => decrementItem(item._id)}>
                                        −
                                    </button>
                                    ...
                                    <strong className={css.lineTotal}>{item.price * item.quantity} Kč</strong>
                                </div>
                                </div>
                            </article>
                            ))}
                            ...
                            <aside className={css.summary}>
                                <h2 className={css.summaryTitle}>Shrnutí objednávky</h2>
                                    ...
                                    <div className={css.freeShip}>
                                        ...
                                        Přidejte ještě <strong>{remainingForFree} Kč</strong> pro dopravu zdarma
                                        </p>
                                    ...
                                    <div className={css.freeShipBadge}>🚚 Doprava zdarma aktivována</div>
                                    )}
